const express = require("express") // aqui estou iniciano o express
const router = express.Router() // aqui estou configurando a primeira parte da rota
const cors = require('cors') // aqui estou trazendo o pacote cors que permite consumir essa API front-end
const conectaBancoDeDados = require('./bancoDeDados') //aqui estou ligando ao arquivo banco de dados
conectaBancoDeDados() //aqui estou chamando a função que conecta ao banco de dados

const Mulher = require('./mulherModel')

const app = express() //aqui estou iniciano o app
